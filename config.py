...
HEALTH_ALERT_ENABLE = os.getenv("HEALTH_ALERT_ENABLE", "1") == "1"
HEALTH_ALERT_DEPOSIT_STALE_MINUTES = int(os.getenv("HEALTH_ALERT_DEPOSIT_STALE_MINUTES", "30"))
HEALTH_ALERT_MIN_INTERVAL_MINUTES = int(os.getenv("HEALTH_ALERT_MIN_INTERVAL_MINUTES", "30"))
